...
class OrdSetTest4 {
    ...
    void a_withMaxElementQtyTest() {
        final OrdSet4 ordSet = new OrdSet4(12);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
    ...
    void b_withMaxResizedTest() {
        final OrdSet4 ordSet = new OrdSet4(8);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
    ...
    void e_withValuesSmallerThanMinimal() {
        final OrdSet4 ordSet = new OrdSet4(1);
    ...
    void f_withValuesGreaterThanMax() {
        final OrdSet4 ordSet = new OrdSet4(17);
    ...
    void h_ResizeOverflowConditionTest() {
        final OrdSet4 ordSet = new OrdSet4(4);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
