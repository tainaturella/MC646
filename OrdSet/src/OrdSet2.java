...
public class OrdSet2 {
    ...
    //representation of the OrdSet2 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet2.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet2 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet2(int size) {
     ...
     */
    public boolean contains(OrdSet2 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet2 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet2 union(OrdSet2 s2) {
        ...
        OrdSet2 set = new OrdSet2(size1 + size2);
