...
class OrdSetTest5 {
    ...
    void a_withMaxElementQtyTest() {
        final OrdSet5 ordSet = new OrdSet5(12);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
    ...
    void b_withMaxResizedTest() {
        final OrdSet5 ordSet = new OrdSet5(8);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
    ...
    void e_withValuesSmallerThanMinimal() {
        final OrdSet5 ordSet = new OrdSet5(1);
    ...
    void f_withValuesGreaterThanMax() {
        final OrdSet5 ordSet = new OrdSet5(17);
    ...
    void h_ResizeOverflowConditionTest() {
        final OrdSet5 ordSet = new OrdSet5(4);
        try {
            ordSet.add(1);
            ordSet.add(2);
            ordSet.add(3);
