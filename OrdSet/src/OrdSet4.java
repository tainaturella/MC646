...
public class OrdSet4 {
    ...
    //representation of the OrdSet4 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet4.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet4 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet4(int size) {
     ...
     */
    public boolean contains(OrdSet4 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet4 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet4 union(OrdSet4 s2) {
        ...
        OrdSet4 set = new OrdSet4(size1 + size2);
