...
public class OrdSet8 {
    ...
    //representation of the OrdSet8 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet8.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet8 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet8(int size) {
     ...
     */
    public boolean contains(OrdSet8 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet8 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet8 union(OrdSet8 s2) {
        ...
        OrdSet8 set = new OrdSet8(size1 + size2);
