...
public class OrdSet7 {
    ...
    //representation of the OrdSet7 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet7.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet7 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet7(int size) {
     ...
     */
    public boolean contains(OrdSet7 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet7 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet7 union(OrdSet7 s2) {
        ...
        OrdSet7 set = new OrdSet7(size1 + size2);
