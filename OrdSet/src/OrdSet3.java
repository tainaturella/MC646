...
public class OrdSet3 {
    ...
    //representation of the OrdSet3 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet3.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet3 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet3(int size) {
     ...
     */
    public boolean contains(OrdSet3 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet3 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet3 union(OrdSet3 s2) {
        ...
        OrdSet3 set = new OrdSet3(size1 + size2);
