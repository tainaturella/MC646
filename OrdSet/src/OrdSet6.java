...
public class OrdSet6 {
    ...
    //representation of the OrdSet6 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet6.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet6 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet6(int size) {
     ...
     */
    public boolean contains(OrdSet6 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet6 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet6 union(OrdSet6 s2) {
        ...
        OrdSet6 set = new OrdSet6(size1 + size2);
