...
public class OrdSet5 {
    ...
    //representation of the OrdSet5 as an array; note that _last + 1 =
    // _set.length
    private int[] _set;
     ...
     * Note that no changes are made to the instance of OrdSet5.
     *
...
//		if the value is not found, return -1
    ...
    /**
     * Create an empty instance of OrdSet5 with default values and
     * a size based on the proposed size.
     *
     * @param size - The proposed size
     */
    public OrdSet5(int size) {
     ...
     */
    public boolean contains(OrdSet5 x) {
        int k, n;
    ...
    /**
     * Union of two sets. It returns an instance of OrdSet5 that is the union of
     ...
     */
    //ACM (private)
    public OrdSet5 union(OrdSet5 s2) {
        ...
        OrdSet5 set = new OrdSet5(size1 + size2);
